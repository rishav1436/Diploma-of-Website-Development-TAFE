<div class="sampleFormBox">
    <form action="../../../app/controller/processCatDelete.php" method="POST">
        <fieldset>
...
<div class="sampleFormBox">
    <form action="../../../app/controller/processCategoryAdd.php" method="POST">
        <fieldset>
...
<div class="sampleFormBox">
    <form action="../../../app/controller/processCatUpdate.php" method="POST">
        <fieldset>
            <legend>Update Category</legend>
